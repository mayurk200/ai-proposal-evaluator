  ...
  async getDashboardStats(userId: string | null) {
    ...
    const scoreHistory = evaluations
      ...
      .map((e) => ({
        ...
        solutionReadinessScore: e.solutionReadinessScore || 0,
        pilotDesignScore: e.pilotDesignScore || 0,
        farmerAdoptionScore: e.farmerAdoptionScore || 0,
        scaleUpScore: e.scaleUpScore || 0,
        teamCapacityScore: e.teamCapacityScore || 0,
